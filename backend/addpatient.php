    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="doctorlist.html">
                    <i class="fas fa-user-md"></i>
                    <span>Doctor List</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="speciality.html">
...
<form method="POST" action="">
	...
	<div class='float-right' style="opacity: 0.6;">
        <a href='patientindex.php' class='btn btn-primary pull-right'>View All</a>
    </div>
	</div>
	</div>
	<div class="row pt-3">
	...
	<div style="text-align: center;" class="pt-4 pb-3">
		<button type="submit" name="patient" class="btn-primary p-2" style="text-align: center; border-radius: 5%; width: 100px;">Add
		</button>
	</div>
</form>
</div>
