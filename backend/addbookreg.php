...
<div class="row pt-3">
	...
	<div class='float-right' style="opacity: 0.6;">
        <a href='bookingregindex.php' class='btn btn-primary pull-right'>View All</a>
    </div>
	</div>
</div>
	<div class="row pt-3">
	...
	<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text"  name="ph"  class="form-control" value=<?php echo $phone; ?>>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text"  name="psw"  class="form-control" value=<?php echo $password; ?>>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text"  name="cpsw"  class="form-control" value=<?php echo $confirm; ?>>
				<span style="color: red"><?php echo $inputerror5; ?></span>
			</div>
		</div>
	</div>
	<div style="text-align: center;" class="pt-4 pb-3">
		<button type="submit" name="bookingreg"  class="btn-primary p-2" style="text-align: center; border-radius: 5%;  width: 100px;">ADD
		</button>
	</div>
</form>
</div>
