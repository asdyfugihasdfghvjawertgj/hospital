...
if (isset($_POST['bookingreg'])) {
	...
	include_once("controller/bookingregcontroller.php");
	$bookingregcontroller=new BookingregController();
	$bookingregcontroller->updatebookingreg($name,$email,$password,$phone,$uid);
...
?>
	...
	<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text"  name="ph"  class="form-control" value=<?php echo $result['phone']; ?>>
				</div>
		</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text"  name="psw"  class="form-control" value=<?php echo $result['password']; ?>>
				</div>
		</div>
    </div>
    <?php
...
?>
	<div style="text-align: center;" class="pt-4 pb-3">
		<button type="submit" name="bookingreg"  class="btn-primary p-2" style="text-align: center; border-radius: 5%;  width: 100px;">Edit
		</button>
	</div>
</form>
</div>
