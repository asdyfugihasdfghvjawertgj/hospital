...
$results=$schedule_control->scheduleDoc($schid);
...
if (isset($_POST['submit']))
{
	include_once("controller/schedulecontroller.php");
	$schedule_control=new ScheduleController();
	$schedule_control->updateSchedule($schid,$_POST["docid"],$_POST["day"],$_POST["start_time"]);
...
?>
					<option value="<?php echo $result['did']; ?>" selected><?php echo $result['dname']; ?></option>
...
?>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				<label>Date</label>
                <select name="day[]"class="form-control day_list" style="height:40px;">
