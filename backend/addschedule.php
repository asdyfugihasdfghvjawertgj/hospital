...
$cresults=$categorycontrol->showParent();
...
?>
	...
	<div class='float-right' style="opacity: 0.6;">
        <a href='scheduleindex.php' class='btn btn-primary pull-right'>View All</a>
    </div>
	</div>
	</div>
			<br />
			...
			<div class="form-group">
                ...
                <tr>
                	<td>
                    <div class="col-md-4">
                    <select name="speciality" id="doc" style="width: 100%;height:40px;">
                        ...
                        <select name="doctor" id="doctor" style="width: 100%;height:40px;">
					...
					<div class="table-responsive">
						<div id="schedule">
							<div class="form-row">
								...
								<div class="form-group col-md-4">
                                <select name="start_time[]" style="width: 100%;height:40px;">
...
$(document).ready(function(){
    ...
    $("#doc").change(function()
    {
      $doc=$(this).val();
      $("#doctor").empty();
        $.get("getdoctors.php",{sub:$doc},function(data){
        $("#doctor").html(data);
       });
    });
});
