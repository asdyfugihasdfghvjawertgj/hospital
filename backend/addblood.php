...
if(isset($_POST['register'])){
	  	...
	  	$userController->createUser($input1,$input2,$input3,$input4,$input5,$input7);
...
if (isset($_POST['add'])) {
	...
	$bloodController->addBlood($name,$email,$phone,$dob,$type);
}
?>
...
<form method="POST" action="">
	...
	<div class='float-right' style="opacity: 0.6;">
        <a href='bloodindex.php' class='btn btn-primary pull-right'>View All</a>
    </div>
	</div>
</div>
	<div class="row pt-3">
	...
	<div style="text-align: center;" class="pt-4 pb-3">
		<button type="submit" name="add" id="add" class="btn-primary p-2" style=" border-radius: 5%; width: 100px;">Add Blood
		</button>
	</div>
