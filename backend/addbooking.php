...
$bresults=$bookinfregController->showBookreg();
...
$bookingController->addBooking($user, $patient,$doctor,$date,$medical);
...
<div class="row pt-3">
	<div class="col-md-12">
	<div class='float-right' style="opacity: 0.6;">
        <a href='bookingindex.php' class='btn btn-primary pull-right'>View All</a>
    </div>
	</div>
</div>
	<div class="row">
	<div class="col-md-12">
			<div class="form-group">
				...
				<select name="user" id="input8" style="width: 100%; height: 40px;">
				<option value="">Please select booking register name</option>
        		<?php
...
?>
<option value="<?php echo $bresult['id'];?>"><?php echo $bresult['name'];?> </option>
<?php
}
?>     
				</select>
	...
	<div class="col-md-12">
			<div class="form-group">
				...
				<br>
				<select name="patient"id="input8" style="width: 100%; height: 40px;">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text" id="input9" name="medical" class="form-control">
				<span style="color: red" id="span9"></span>
			</div>
		</div>
	</div>
	<div style="text-align: center;" class="pt-4 pb-3">
		<button type="submit" id="booking" name="booking" class="btn-primary p-2" style="text-align: center; border-radius: 5%; border:1px solid green; width: 100px;">Add
		</button>
	</div>
</form>
</div>
