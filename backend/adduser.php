...
<form method="POST" action="">
	...
	<div class='float-right' style="opacity: 0.6;">
        <a href='userindex.php' class='btn btn-primary pull-right'>View All</a>
    </div>
	</div>
	</div>
	<div class="row pt-3">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="date" name="input4" class="form-control">
	...
	<div class="col-md-12">
			<div class="form-group">
				...
				<input type="password" name="input6" class="form-control">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="password" name="input7" class="form-control">
				<span style="color: red"><?php echo $inputerror7; ?></span>
			</div>
		</div>
	</div>
	<div style="text-align: center;" class="pt-4 pb-3">
		<button type="submit" name="register" id="reg" class="btn-primary p-2" style="text-align: center; border-radius: 5%; width: 100px;">Add
		</button>
	</div>
</form>
</div>
